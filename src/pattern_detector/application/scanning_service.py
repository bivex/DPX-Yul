"""Application scanning service orchestrating Yul & EVM Assembly pattern detection."""
...
class ScanningService(ScannerPort):
    """Coordinates discovering, parsing, rule evaluation, and exporting for Yul / EVM Assembly."""
