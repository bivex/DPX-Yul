"""Filesystem source provider adapter for discovering Yul & EVM Assembly source files (.yul, .sol)."""
...
class FileSourceProvider(SourceProviderPort):
    """Recursively discovers and reads Yul source files (.yul, .sol) from disk."""
