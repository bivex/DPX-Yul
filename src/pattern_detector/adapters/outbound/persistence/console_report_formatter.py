"""Console Rich Formatter for Yul & EVM Assembly pattern detection findings."""
...
class ConsoleReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        ...
        # Header Banner
        header = Panel.fit(
            f"[bold white]🔥 DPX-Yul: EVM Memory Layouts, Storage Packing, Transient Storage (EIP-1153) & GoF 23[/bold white]\n"
        ...
        console.print(table)
        console.print("\n[bold]📋 Identified Yul & EVM Assembly Architectural Patterns & Signals:[/bold]\n")
